"Resource/GameMenu.res"
{
    ...
    {
        "label"                                                     "favorite"
        "command"                                                   "engine connect server;password "
        "OnlyAtMenu"                                                "0"
    }
	"Version"
	{
		"label" 									"m0rehud-d"
		"command" 									"engine showconsole;clear; echo m0rehud edit by donovin; echo twitch.tv/donovin_;echo twitter.com/donovin_"
		"OnlyAtMenu"								"1"
	}
	"Servers"
	{
	...
	"Toggle Netgraph"
	{
		...
		"tooltip"									"Enable/Disable MatchHud"
		"OnlyInGame"								"1"
	}
	"Toggle Contracts"
	{
