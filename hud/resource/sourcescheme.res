...
Scheme
{
	...
	Colors
	{
	    "TFDarkBrown"               "50 50 50 255"
	    "TFDarkBrownTransparent"    "50 50 50 190"
	    "TFTanBright"               "220 220 220 150"
	    "TFTanLight"                "255 255 255 150"
	    "TFTanMedium"               "121 121 121 150"
	    
	    "TFTanLightBright"          "222 222 222 90"
	    "TFTanLightDark"            "90 90 90 90"
	    
	    "TFOrangeBright"            "255 150 150 255"
	    
	    "TFTextBright"              "235 235 235 150"
	    "TFTextLight"               "190 190 190 255"
	    "TFTextMedium"              "120 120 120 255"
	    "TFTextMediumDark"          "96 96 96 255"
	    "TFTextBlack"               "42 42 42 255"
	    "TFTextDull"                "131 121 104 255"

	    "TFMediumBrown"		"67 67 67 255"

	    "QuickListBGDeselected"		"65 65 65 255"
	    "QuickListBGSelected"               "118 118 118 150"
	    
	    "Blank"				"0 0 0 0"
	    
	    // background colors
		"ControlBG"			"87 87 87 255"		// background color of controls
		"ControlDarkBG"		"77 77 77 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"40 40 40 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"85 85 85 255"	// background color of any selected text or menu item
		"SelectionBG2"		"90 90 90 255"		// selection background in window w/o focus
	...
	BaseSettings
	{
		...
		ListPanel.SelectedBgColor			"0 150 180"
