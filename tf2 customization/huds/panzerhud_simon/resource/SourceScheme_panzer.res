...
Scheme
{
	...
	Colors
	{
		...
		"NotoGreen"				"10 10 10 255"
		"LITEDARKBLU"			"5 5 5 255"
		"MEDDARKBLU"			"5 5 5 255"
		"DARKBLUGRAY"			"5 5 5 255"
		
		"OLIVE"					"96 94 69 255"
		"OLIVE2"				"122 122 82 255"
	...
	BaseSettings
	{
		...
		Button.BgColor					"OLIVE"
		Button.ArmedTextColor			"Black"
		Button.ArmedBgColor				"OLIVE2"
		Button.DepressedTextColor		"Black"
		Button.DepressedBgColor			"OLIVE2"
		Button.FocusBorderColor			"0 0 0 0"

		CheckButton.TextColor			"OLIVE"
		...
		Frame.OutOfFocusBgColor			"OLVIE"
		FrameGrip.Color1				"OLIVE"
		FrameGrip.Color2				"OLIVE"
		FrameTitleButton.FgColor		"OLIVE"
		FrameTitleBar.Font				"Harabara9"
		...
		ListPanel.TextColor					"OLIVE"
		ListPanel.BgColor					"MEDDARKBLU"
		ListPanel.SelectedBgColor			"OLIVE"
		ListPanel.SelectedOutOfFocusBgColor	"100 100 100 128"

		MainMenu.TextColor			"OLIVE"
		MainMenu.ArmedTextColor		"OLIVE"
		MainMenu.Inset				"32"
		...
		ScrollBarSlider.FgColor				"20 20 20 255"
		ScrollBarSlider.BgColor				"Blank" //scrollbar bg

		Slider.NobColor				"NotoWhite"
		Slider.TextColor			"OLIVE2"
		...
		TextEntry.SelectedBgColor	"OLIVE2"
		...
		RichText.BgColor				"OLIVE" //console bg
		RichText.SelectedTextColor		"OLIVE2"
